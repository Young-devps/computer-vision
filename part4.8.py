...
import cv2
import os
from trainer import entrainer  # contoler after because this module will be call from yhe main.py Tkinter mod
...
def apprendre(count, face_id):
    ...
    while True:
        ...
        for (x, y, w, h) in faces:
            ...
            cv2.imwrite("dataset/Stud." + str(face_id) + '.' + str(count) + ".jpg", gray[y:y + h, x:x + w])
